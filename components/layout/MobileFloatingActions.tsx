...
// Two independent floating circular icon buttons, mobile only -- Call
// bottom-left, WhatsApp bottom-right. Replaces an earlier full-width
// sticky bar (read as unprofessional) with the same visual language
// already used by the desktop-only WhatsAppFloat button (same size,
// shadow, z-index), just split into a pair and moved to the corners.
// Mounted alongside WhatsAppFloat on every page.
