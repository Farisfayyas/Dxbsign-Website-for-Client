...
// Contact page body, split out of app/contact/page.tsx so it can read
          ...
          <div className="section-x relative py-[clamp(56px,9vw,108px)] pb-[calc(clamp(56px,9vw,108px)+48px)] sm:pb-[calc(clamp(56px,9vw,108px)+72px)]">
            <StaggerReveal className="flex flex-col gap-4" stagger={0.18} y={22}>
              ...
              <p className="max-w-[720px] text-[17px] leading-relaxed text-white/90 [text-shadow:0_1px_8px_rgba(0,0,0,0.35)]">
                {isAr
                  ? "أخبرنا عن احتياجك من سواري الأعلام أو اللافتات، وسيرد فريقنا بمواصفات وعرض سعر. تفضّل التحدث مباشرة؟ اتصل بنا أو راسلنا أدناه."
          ...
          <div className="section-x grid grid-cols-1 gap-4 pt-10 sm:grid-cols-3">
            ...
            <a href={whatsapp.href} target="_blank" rel="noopener noreferrer" className={tileClass}>
              ...
              <span>
                ...
                <span className="block text-lg font-bold text-ink">{isAr ? "تواصل الآن" : "Chat Now"}</span>
              </span>
            </a>
            ...
            <div className="flex flex-col gap-5">
              <div className="bg-ink p-8 text-white">
                <div className="mb-4 font-serif text-[11px] font-semibold uppercase tracking-[0.1em] text-[oklch(65%_0.08_250)]">
                  {isAr ? "العنوان وساعات العمل" : "Address & Hours"}
                </div>
                <div className="text-sm leading-[1.9] text-[oklch(85%_0.005_250)]">
                  ...
                  <div className="mt-2.5">{isAr ? site.hoursAr : site.hours}</div>
                </div>
              </div>
              <iframe
